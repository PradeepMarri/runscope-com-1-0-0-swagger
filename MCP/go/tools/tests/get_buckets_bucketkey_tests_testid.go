...
func Get_buckets_bucketkey_tests_testidHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGet_buckets_bucketkey_tests_testidTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_buckets_bucketKey_tests_testId",
		mcp.WithDescription("Retrieve the details of a given test by ID."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_buckets_bucketkey_tests_testidHandler(cfg),
	}
}
