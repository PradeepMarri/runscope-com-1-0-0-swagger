...
func Post_buckets_bucketkey_tests_testid_stepsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/buckets/%s/tests/%s/steps", cfg.BaseURL, bucketKey, testId)
...
func CreatePost_buckets_bucketkey_tests_testid_stepsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_buckets_bucketKey_tests_testId_steps",
		mcp.WithDescription("Add new test step."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_buckets_bucketkey_tests_testid_stepsHandler(cfg),
	}
}
