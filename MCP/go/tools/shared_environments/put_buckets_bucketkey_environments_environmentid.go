...
func Put_buckets_bucketkey_environments_environmentidHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/buckets/%s/environments/%s", cfg.BaseURL, bucketKey, environmentId)
...
func CreatePut_buckets_bucketkey_environments_environmentidTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_buckets_bucketKey_environments_environmentId",
		mcp.WithDescription("Update the details of a shared environment."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_buckets_bucketkey_environments_environmentidHandler(cfg),
	}
}
